...
def fetch_movies(genre, language, min_avg_rating):
...
def main():
    ...
    if st.button('Show Movies') and (genre != 'Select a genre' or language != 'Select a language' or min_avg_rating != 'Select a rating'):

        movies_list = fetch_movies(genre, language, min_avg_rating)
        ...
        st.write('Please select a genre, language, and minimum average rating and click on "Show Movies"')
